...
-   [x] background on the Cook Inlet research project (number of seals, years,
    etc)
-   [x] data handling and management
-   [x] map of raw argos locations / consider hex count instead
-   [x] figure of data density (number of seal hours/day over years)
-   [ ] example figure of percent-dry timeline data
...
```{r fig-obs-map, include=TRUE, echo = FALSE, fig.height=6}
